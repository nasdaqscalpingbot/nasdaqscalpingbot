...
class ScalpingbotView(QMainWindow):
    ...
    def __init__(self, parent=None):
        ...
        # Define label texts
        label_texts = ["Last update:", "Candle #:", "Market status:", "Current P&L:", "Day profit:", "Balance:"]
    ...
    def update_ui(
            self, candles, macd, signal, advice, start_balance, start_datetime,
        ...
        self.label_map = {
            "Last update:": self.labels[0],
            "Candle #:": self.labels[1],
            "Market status:": self.labels[2],
        ...
        self.conditions_area.update_conditions(candles, macd, signal)
